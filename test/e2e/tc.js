...
module.exports = {
  'Inspirational Search': '' + function (browser) {
    ...
    browser
      ...
      .saveScreenshot(utils.imgpath() + 'tc_home.png')
      .setValue('input[type=text]', 'Span')
      .waitForElementVisible('.list-group-item')
      .pause(500)
      .saveScreenshot(utils.imgpath() + 'tc_autocomplete.png')
      // simulate the down arrow key being pressed:
      .keys(browser.Keys.DOWN_ARROW)
      .saveScreenshot(utils.imgpath() + 'tc_autocomplete_click_first.png')
      ...
      .saveScreenshot(utils.imgpath() + 'tc_tags.png')
      .moveToElement('.articleTileImage', 200, 800)
      .saveScreenshot(utils.imgpath() + 'tc_result_initial.png')
      .moveToElement('.articleTileImage', 200, 800)
      .saveScreenshot(utils.imgpath() + 'tc_result_article.png')

      .waitForElementVisible('.packageContainer')
      .assert.containsText('.packageContainer', 'Spanien') //
      .moveToElement('.packageContainer', 10, 400)
      .saveScreenshot(utils.imgpath() + 'tc_result_package.png')
      ...
      // .pause(500)
      .saveScreenshot(utils.imgpath() + 'tc_package.png')
      // click on bookButton
      .click('.bookButton')
      .pause(500)
      .waitForElementVisible('.quickfactheader')
      .assert.containsText('.quickfactheader', 'Hotelfakta')
      .saveScreenshot(utils.imgpath() + 'tc_booking_page.png')
      .execute(function () {
        window.history.back()
      })
      .pause(500)
      .saveScreenshot(utils.imgpath() + 'tc_package_again.png')
      .click('.backButton')
      .waitForElementVisible('#container')
      .pause(500)
      .assert.containsText('#container', 'Hvor vil du rejse hen')
      .saveScreenshot(utils.imgpath() + 'tc_isearch_home.png')
      .end();
  }
};
